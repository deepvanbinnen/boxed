<cfcomponent extends="HTMLInterface">
	...
	<cffunction name="setOutput">
		...
		<cfloop from="1" to="#variables.stack.recordcount#" step="-1" index="lcl.i">
			<cfset variables.output = get(variables.stack["tag"][lcl.i], variables.stack["attr"][lcl.i], variables.output)>
		</cfloop>
